...
class Car {
  ...
  drive(distance){
    if(this.tank - distance / this.milesPerGallon >= 0){
      ...
      let missing = distance / this.milesPerGallon - this.tank;
      this.odometer += distance - missing;
      this.tank = 0;
...
class ProjectManager extends Instructor{
  ...
  this.specialty = projectManagerAttr.specialty,
  this.favLanguage = projectManagerAttr.favLanguage,
